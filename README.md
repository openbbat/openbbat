## Hi there 👋
# Marcin "HCK" Firmuga
**22 - Poland 🇵🇱 - solo dev - founder of [HCK_Labs](https://github.com/openbbat) - I ship real products in public.**
...
[![committers.top badge](https://user-badge.committers.top/poland/openbbat.svg)](https://user-badge.committers.top/poland/openbbat)
...
**[PC Workman](https://github.com/openbbat/PC_Workman_HCK)** - a Windows system monitor that tells you *why* your PC is slow, not just that it is.
...
**[GuideAI](https://github.com/openbbat/guide-ai)** - turn 100-page PDF manuals into QR-code AI assistants. Because paper manuals suck.
...
✅ **Roadmap to the Microsoft Store — reached.** → [next chapter loading](https://github.com/users/openbbat/projects/4/views/4).
...
<!--
**openbbat/openbbat** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
